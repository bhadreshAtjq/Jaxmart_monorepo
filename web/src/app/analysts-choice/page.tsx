...
import analystBannerImage from '@/components/assets/images/analyst.png';
...
export default function AnalystsChoicePage() {
  return (
    <Suspense fallback={<ListingCardSkeleton />}>
      <AnalystsChoiceContent />
    </Suspense>
  );
}

function AnalystsChoiceContent() {
  ...
  return (
    <PublicLayout>
      {/* Custom Theme Surface Page Wrapper for Analyst's Choice */}
      <div className="bg-[#324C41] min-h-screen pb-16">
...
// ── ANALYST'S CHOICE HERO BANNER ──────────────────────────────────────────────
function AnalystsChoiceHero() {
  return (
    <motion.div
    ...
    >
      <div className="w-full h-[180px] sm:h-[240px] md:h-[280px] relative flex items-center justify-start overflow-hidden">
        <Image 
          src={analystBannerImage} 
          alt="Expert's Pick Banner" 
          fill 
        ...
        <div className="absolute inset-y-0 left-0 flex flex-col justify-center px-8 sm:px-12 lg:px-16 max-w-2xl z-10">
          <div className="flex items-center gap-3 md:gap-4 mb-2">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-black text-white tracking-tight leading-none drop-shadow-md">
              <span className="text-[#EA3323]">E</span>XPERT'S PICK
            </h1>
            <div className="bg-[#fce588] rounded-[20px] px-3 py-0.5 flex items-center justify-center shadow-md">
              <span className="text-[#EA3323] font-black text-base sm:text-lg md:text-xl italic pr-0.5">E</span>
              <span className="text-gray-900 font-black text-base sm:text-lg md:text-xl italic">P</span>
            </div>
          </div>

          <p className="text-white text-sm sm:text-base md:text-lg font-medium mt-1 sm:mt-2 max-w-md leading-snug">
            Handpicked, premium quality products. Unbiased expert selection.
          </p>
        </div>
      </div>
    </motion.div>
