               ...
               <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                  <div>
                     <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-[10px] font-black text-jax-accent uppercase tracking-[0.22em]">My Orders</span>
                     </div>
                     <h1 className="text-3xl font-heading font-black text-jax-dark tracking-tighter leading-none mb-2">My Orders</h1>
                     <p className="text-sm text-gray-500 font-medium">Manage your orders, progress, and secure payments.</p>
                     ...
                     <div className="flex items-center gap-8 px-8 py-3 bg-gray-50 rounded-2xl border border-gray-100">
                        <div className="text-left">
                           <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-1">
                              {role === 'buyer' ? 'Total Value' : 'Total Sales'}
                           </p>
         ...
         <Container size="xl" className="pb-20">
            {!orders?.length ? (
               <EmptyState
                  ...
                  title="No orders yet"
                  description="Start by browsing products or posting a request."
                  action={<Button className="bg-jax-accent text-white border-none px-10 h-12 shadow-xl shadow-jax-accent/20" onClick={() => router.push('/search')}>Browse Products</Button>}
               />
            ) : (
               <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                  <div className="lg:col-span-3 space-y-4">
                     <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xs font-black text-jax-dark uppercase tracking-widest">Orders</h2>
                         <div className="flex gap-2">
                            <button 
                              onClick={() => {
                                 ...
                                 a.href = url;
                                 a.download = `jaxmart_orders_${role}.csv`;
                                 a.click();
                              }}
                            ...
                            >
                               <FaFileInvoiceDollar className="h-2.5 w-2.5" /> Export CSV
                            </button>
                               ...
                               <div className="flex flex-col md:flex-row">
                                  <div className="p-6 flex-1 flex items-start gap-6">
                                     ...
                                     <div className="min-w-0">
                                        ...
                                        <h3 className="font-heading font-black text-jax-dark text-base uppercase tracking-tight group-hover:text-jax-accent transition-colors truncate">
                                           Order for {order.rfqQuote?.rfq?.title || 'Products'}
                                        </h3>
                                  ...
                                  <div className="bg-gray-50/50 md:w-56 p-6 border-l border-gray-100 flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center gap-1 shrink-0">
                                     ...
                                     <div className="hidden md:flex items-center gap-1 text-[9px] font-black text-jax-blue uppercase mt-2">
                                        View Details <FaArrowRight className="h-2 w-2" />
                                     </div>
                                  </div>
                               </div>
                            </Card>
                   ...
                   <div className="space-y-6">
                      <Card className="bg-emerald-600 text-white p-6 shadow-xl shadow-emerald-500/10 border-none">
                         <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-[11px] font-black uppercase tracking-widest">Payment Protection</span>
                         </div>
                         <p className="text-xs text-white/80 font-medium leading-relaxed mb-6">
                            Payments are held safely by JaxMart and only released to the seller after you confirm delivery.
                         </p>
                         <button className="w-full py-2.5 bg-white text-emerald-700 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-50 transition-colors">Learn More</button>
                      </Card>

                      <div className="p-6 bg-white border border-gray-100 rounded-3xl shadow-sm">
                         <h4 className="text-[10px] font-black text-jax-blue uppercase tracking-widest mb-6">Shipping Info</h4>
                         <div className="space-y-6">
                            {[
                               { icon: FaTruckFast, label: 'Tracking', val: 'Connected' },
                               { icon: FaBoxesStacked, label: 'Inventory', val: 'Active' }
                            ].map((item, i) => (
