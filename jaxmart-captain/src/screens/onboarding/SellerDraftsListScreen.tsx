// src/screens/onboarding/SellerDraftsListScreen.tsx
...
interface SellerDraftsListScreenProps {
  navigation: any;
}

export const SellerDraftsListScreen: React.FC<SellerDraftsListScreenProps> = ({ navigation }) => {
  const { drafts, loadDraft, deleteDraft, startNewWizard } = useSellerWizardStore();

  const handleResumeDraft = async (draftId: string) => {
    await loadDraft(draftId);
    navigation.navigate('Step1BasicProfile');
  };
  ...
  const handleDelete = (draftId: string) => {
    Alert.alert('Delete Draft', 'Are you sure you want to discard this merchant draft?', [
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={styles.headerTitle}>Seller Onboarding Drafts</Text>
          <Text style={styles.headerSubtitle}>Resume incomplete merchant registrations</Text>
        </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyTitle}>No Pending Seller Drafts</Text>
              <Text style={styles.emptySubtitle}>
                Tap "+ New" to begin onboarding a new B2B merchant on-site.
              </Text>
            </View>
          }
        />
